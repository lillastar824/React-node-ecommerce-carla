...
const rows = [
  createData('1', 'Ring1', 'test', '0'),
  createData('2', 'Ring1', 'test', '0'),
  createData('3', 'Ring1', 'test', '0'),
  createData('4', 'Ring1', 'test', '0'),
  createData('5', 'Ring1', 'test', '0'),
  createData('6', 'Ring1', 'test', '0'),
  createData('7', 'Ring1', 'test', '0'),
  createData('8', 'Ring1', 'test', '0'),
  createData('9', 'Ring1', 'test', '0'),
  createData('10', 'Ring1', 'test', '0'),
];
...
const fields = ['id', 'name', 'description', 'count', 'action']
      ...
      <CCard>
        ...
        <CCardBody>
          <div style={{ width: 500 }}>
            ...
            >
              <DialogTitle id="alert-dialog-slide-title" style={{ backgroundColor: '#db4b31', color: '#fff' }}>{"Create Style"}</DialogTitle>
              <DialogContent>
