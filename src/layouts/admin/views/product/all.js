...
function createData(img, price, stock, name, style, collection, category, stoneclass, styletype) {
  return { img, price, stock, name, style, collection, category, stoneclass, styletype };
}

const rows = [
  createData('Cupcake', 350, 0, '14KY (2) CUSHION-AMETH', '90302AM', 'Nancy B Color', 'None', 'Semi Precious', 'Earrings'),
  createData('Cupcake', 350, 0, '14KY (2) CUSHION-AMETH', '90302AM', 'Nancy B Color', 'None', 'Semi Precious', 'Earrings'),
  createData('Cupcake', 350, 0, '14KY (2) CUSHION-AMETH', '90302AM', 'Nancy B Color', 'None', 'Semi Precious', 'Earrings'),
  createData('Cupcake', 350, 0, '14KY (2) CUSHION-AMETH', '90302AM', 'Nancy B Color', 'None', 'Semi Precious', 'Earrings'),
  createData('Cupcake', 350, 0, '14KY (2) CUSHION-AMETH', '90302AM', 'Nancy B Color', 'None', 'Semi Precious', 'Earrings'),
...
const headCells = [
  ...
  { id: 'style', numeric: true, disablePadding: false, label: 'STYLE ID' },
  { id: 'collection', numeric: true, disablePadding: false, label: 'COLLECTION' },
  { id: 'category', numeric: true, disablePadding: false, label: 'CATEGORY' },
  { id: 'stoneclass', numeric: true, disablePadding: false, label: 'STONECLASS' },
  { id: 'styletype', numeric: true, disablePadding: false, label: 'STYLE CATEGORY' },
          ...
          <CRow className='p-2'>
            <CCol xs='4' className='pl-4 d-inline-flex'>
              <CInput
                ...
                size="sm"
              />
              <CButton color="light" className="my-2 my-sm-0">Search</CButton>
            </CCol>
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="center">{row.stoneclass}</TableCell>
                          <TableCell align="center">{row.styletype}</TableCell>
                          <TableCell align="center">
                            <EditIcon onClick={() => { props.history.push('/products/create') }} style={{ cursor: 'pointer' }} />
                          </TableCell>
                          <TableCell align="center">
